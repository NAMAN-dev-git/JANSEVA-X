...
const navItems = [{ to: "/", label: "Home", end: true }, { to: "/services", label: "Services" }, { to: "/applications", label: "My Applications" }, { to: "/exams", label: "Government Exams" }, { to: "/exam-applications", label: "My Exam Applications" }, { to: "/documents", label: "Issued Demo Documents" }, { to: "/profile", label: "Profile" }];
