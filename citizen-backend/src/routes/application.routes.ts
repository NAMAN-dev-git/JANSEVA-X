...
applicationRouter.use(requireAuth, requireActiveAccount, requireRole("CITIZEN"));
...
applicationRouter.post("/:applicationId/complete", validate(applicationCompletionSchema), asyncHandler(completeGeneratedDocumentWorkflow));
